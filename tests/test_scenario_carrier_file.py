...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        dexpress_fileformat, = FileFormat.find(
            [('name', '=', 'DynamicExpress')], limit=1)
        ...
        dexpress.save()
        dexpresscomplete_fileformat, = FileFormat.find(
            [('name', '=', 'DynamicExpress Complete')], limit=1)
        ...
        fcontent = file.read()
        file.close()
        self.assertEqual('Customer' in fcontent, True)
        sale2.click('quote')
        sale2.click('confirm')
        sale2.click('process')
        sale2.reload()
